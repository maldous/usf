...
export const ACTION_PERMISSIONS: Readonly<Record<string, string>> = Object.freeze({
  ...
  "job.schedule.create": "job.schedule.create",
  "job.schedule.update": "job.schedule.update",
  "job.schedule.disable": "job.schedule.disable",
  "job.run": "job.run",
  ...
  "workflow.admin.override": "workflow.admin.override",
