...
SOURCE_USE = "docs/architecture/provider-adapters-source-use-disposition-matrix.md"
...
FUNCTIONALITY_MATRIX = "docs/architecture/usf-functionality-completeness-matrix.json"
