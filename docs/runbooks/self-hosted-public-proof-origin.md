...
(proof_route_handlers) {
	...
	handle @routeAllowed {
		...
		respond `<!doctype html><html lang="en"><head><meta charset="utf-8"><title>USF public route proof</title><meta name="usf-proof-marker" content="usf-public-route"><meta name="usf-environment" content="{args.0}"><meta name="usf-fqdn" content="{args.1}"><meta name="usf-telemetry-bootstrap" content="faro-sentry-bounded-bootstrap"></head><body><main data-usf-proof-marker="usf-public-route" data-usf-environment="{args.0}" data-usf-fqdn="{args.1}" data-usf-telemetry-bootstrap="faro-sentry-bounded-bootstrap">USF public route proof only.</main><script type="application/json" id="usf-public-route-telemetry">{"marker":"usf-public-route","telemetryBootstrap":"faro-sentry-bounded-bootstrap","systems":["faro","sentry"],"productUiReadiness":false,"browserE2eReadiness":false}</script></body></html>` 200
	}
...
This runbook does not claim staging readiness, production readiness, deployment readiness, live-provider readiness, SOC readiness, ISO/IEC 27001 certification, enterprise production readiness, product UI readiness, browser E2E readiness, or full React parity.
