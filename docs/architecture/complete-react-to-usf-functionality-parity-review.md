...
| files-storage              | Files/storage                | partial                 | B     | P1           | USF-146/USF-147/USF-175/USF-200                                  | ClamAV composed scanner, richer DLP, and enterprise storage depth remain deferred; scanner provider semantics are tracked by USF-175/USF-200.                                                                                                                                                                                                            |
...
| file-scanning              | File scanning                | deferred                | C     | P1           | USF-175/USF-200                                                   | USF-175 records bounded scanner provider disposition only; composed ClamAV scanner proof remains deferred to USF-200, with no live scanner or DLP readiness claim.                                                                                                                                                                                        |
