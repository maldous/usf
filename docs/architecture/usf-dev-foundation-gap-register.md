...
| P1-006 | ClamAV composed file scanning absent                    | USF-175 records a bounded file scanner provider disposition with deterministic scan markers kept non-equivalent to deferred USF-200 ClamAV adapter and service-semantic proof for clean/infected outcomes, fail-closed quarantine, release, deletion, retention, retry, audit, teardown, and provider failure modes. | No ClamAV/live malware scanning/DLP readiness claim. |
| P1-007 | LocalStack and WireMock mock-provider parity unresolved | USF-176 records bounded mock-provider substrate disposition and non-equivalence for LocalStack, WireMock, webhook sink capture, and mock OIDC; USF-201 owns actual service-semantic proof. | No external-provider mock completeness or live-provider compatibility claim. |
...
surfaces, backup/restore (USF-177 disposition, USF-202 proof), Windmill operator automation (USF-178 disposition, USF-203 proof), scanner, observability backend, quality-gate, mock-provider (USF-176 disposition, USF-201 proof),
