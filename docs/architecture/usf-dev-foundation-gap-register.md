...
| P1-007 | LocalStack, WireMock, and mock OIDC mock-provider parity unresolved | USF-201 proves bounded webhook-sink local capture only. LocalStack service semantics remain USF-208, WireMock service semantics remain USF-209, and mock OIDC service semantics remain USF-210. | No local mock completeness, notification delivery, external-provider compatibility, or live-provider readiness claim. |
| P1-008 | pgBackRest backup/restore proof absent                  | USF-177 records a bounded backup/restore disposition linked to USF-202; DB/RLS/files proof, documentation, or fixture evidence is not backup artifact or restore drill proof. | No backup/restore or disaster recovery readiness claim. |
| P1-009 | Windmill operator automation parity unresolved          | USF-178 records a bounded operator workflow disposition linked to USF-203; Temporal application workflow proof, jobs proof, and worker runtime proof are not Windmill operator automation proof.          | No operator automation or Windmill readiness claim.       |
...
| HD-006 | Are LocalStack, WireMock, and mock OIDC required mock-provider substrates beyond bounded webhook-sink capture? USF-201 proves only webhook-sink capture; USF-208, USF-209, and USF-210 own the remaining service semantics if required. |
...
| React parity: non-runtime composed service disposition      | USF-183 proves the service-catalogue-required runtime provider bindings that have USF runtime ports. Operator surfaces, backup/restore, scanner, observability backend, quality-gate, mock-provider (USF-176 disposition, USF-201 webhook-sink capture proof, USF-208/USF-209/USF-210 remaining mock substrates), gateway, and automation service disposition still require USF-133 decisions. | P0 follow-up under USF-133 |
...
surfaces, backup/restore (USF-177 disposition, USF-202 proof), Windmill operator automation (USF-178 disposition, USF-203 proof), scanner, observability backend, quality-gate, mock-provider (USF-176 disposition, USF-201 webhook-sink capture proof, USF-208/USF-209/USF-210 remaining mock substrates),
