...
| MinIO | `MinioObjectStore` | `minio@8.0.7` | bounded exponential, `60s` | bucket readiness, object write/read/delete, tenant-boundary check |
...
| OpenBao | `OpenBaoSecretStore` | `node-vault@0.12.0` | bounded exponential, `60s` | health, write, describe, resolve, tenant-boundary check, cleanup |
