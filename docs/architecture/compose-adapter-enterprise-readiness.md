...
| Keycloak | `KeycloakComposedIdentityProvider`   | `@keycloak/keycloak-admin-client@26.5.6` | bounded exponential, `120s` | admin readiness, synthetic identity readback, fail-closed tenant check                                                                                                                  |
