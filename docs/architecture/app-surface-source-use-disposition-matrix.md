...
- `apps/web`, `apps/mobile`, and `packages/app-surface` remain future-to-create paths owned by their separate Linear issues and require their own topology, source-use, and validation coverage before files are created.
