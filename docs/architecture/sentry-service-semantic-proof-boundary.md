# USF-196 / USF-205 Sentry Service Semantic Proof Boundary

This note records the Sentry service semantic proof boundary after USF-196 and USF-205. USF-196 reclassified Sentry service proof as explicitly deferred with owner, risk owner, control owner, review date, validator coverage, and non-equivalence to local deterministic observability proof. USF-205 adds an accepted official Sentry Node SDK envelope proof for local event-shape capture, redaction, tenant-safe opaque labels, value-free retention posture, and unavailable-transport fail-closed behaviour.
