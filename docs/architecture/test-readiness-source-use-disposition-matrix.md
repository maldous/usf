...
| `docs/architecture/future-ai-delivered-work-semantic-test-guardrail.json` | new-with-rationale | USF-252 future AI-delivered work guardrail acceptance and semantic service test obligation manifest | Adds machine-readable path-to-obligation, weakening-detector, generated Compose authority, diagnostic, planted-defect, and non-claim guardrail evidence for future AI/developer changes. |
| `docs/architecture/future-ai-delivered-work-semantic-test-guardrail.md` | explanatory-doc-support | USF-252 future AI-delivered work guardrail acceptance | Explains the bounded guardrail workflow without creating runtime implementation authority or final USF-234 acceptance. |
| `tests/packages/future-ai-delivered-work-semantic-test-guardrail.test.ts` | new-with-rationale | USF-252 executable guardrail acceptance and machine-readable future AI guardrail evidence | Adds deterministic repository tests for change impact mapping, coupled update requirements, weakening detection, generated Compose authority boundaries, diagnostics, planted defects, and non-claims. |
