...
| `docs/architecture/react-parity-scope-classification-matrix.json` search rows | matrix | rewrite-from-behaviour | USF source lineage: search source and proof inventory | implemented | Domain-authorised rows reference USF-164. |
