...
Runtime files in this slice have source-use disposition `rewrite-from-behaviour`. They are USF-native implementations aligned to current USF semantics, not copied source-lineage code.
