...
| `parity` | Validator suite inherited from React-to-USF reconciliation | compatibility-alias | Keep because validators remain authoritative, but describe as foundation coverage validation rather than full product readiness. Add `validate-coverage` alias in USF-232. |
