...
export const PROVIDER_REGISTRY: readonly ProviderRegistryEntry[] = Object.freeze([
  ...
  makeProvider({
    providerId: "analytics-store-clickhouse-composed-test",
    providerName: "ClickHouse composed-test analytics event-store provider",
    providerCategory: "analytics-store",
    providerMode: "composed-test",
    owningCapability: "analytics-event-store",
    portName: "AnalyticsEventStore",
    adapterName: "ClickHouseComposedAnalyticsEventStoreAdapter",
    businessPurpose:
      "SDK-backed local Compose ClickHouse analytics event-store proof for deterministic synthetic tenant-safe event ingestion, query, aggregation, retention cleanup, and unavailable-provider fail-closed behaviour.",
    dataClassification: "restricted",
    healthStatus: "healthy",
    readinessStatus: "healthy",
    capabilityStatus: "healthy",
    explicitAuthorityRef: "spec/instances/compose-service/service-catalogue.json#clickhouse",
    ...
    resiliencePosture: {
      connectTimeout: "5s",
      requestTimeout: "5s",
      retryPolicy: "bounded-exponential-backoff-90s",
      circuitBreakerPolicy: "fail-closed-unavailable-state",
    },
    credentialPosture: {
      secretClassification: "none",
      credentialScope: "compose_local_clickhouse_no_auth",
      leastPrivilegePolicy:
        "local Compose ClickHouse proof uses no credential and grants only synthetic proof table create insert query truncate drop actions",
    },
    supplierPosture: { subprocessorStatus: "not-live-local-compose-only" },
    permissionGrants: [
      {
        providerAction: "analytics.proof_table.create",
        providerPermission: "write",
        credentialScope: "compose_local_clickhouse",
        allowedResourceScope: "proof-table-only",
        tenantScope: "tenant-scoped",
      },
      {
        providerAction: "analytics.events.insert",
        providerPermission: "write",
        credentialScope: "compose_local_clickhouse",
        allowedResourceScope: "synthetic-proof-events",
        tenantScope: "tenant-scoped",
      },
      {
        providerAction: "analytics.events.query",
        providerPermission: "read",
        credentialScope: "compose_local_clickhouse",
        allowedResourceScope: "hashed-tenant-proof-events",
        tenantScope: "tenant-scoped",
      },
      {
        providerAction: "analytics.proof_table.drop",
        providerPermission: "delete",
        credentialScope: "compose_local_clickhouse",
        allowedResourceScope: "proof-table-only",
        tenantScope: "tenant-scoped",
  ...
  makeProvider({
    ...
    providerName: "ClickHouse analytics store provider class",
    providerCategory: "analytics-store",
    providerMode: "live-external-deferred",
    owningCapability: "analytics-event-store",
    portName: "AnalyticsEventStore",
    adapterName: "ClickHouse provider deferred",
    businessPurpose:
      "Recognised analytics/event-store provider class; not implemented, not adapter-bound, and not ready for live or composed-provider claims.",
    dataClassification: "restricted",
    healthStatus: "deferred",
    readinessStatus: "deferred",
    capabilityStatus: "deferred",
    explicitAuthorityRef: "spec/instances/compose-service/service-catalogue.json#clickhouse",
    sourceUseDisposition: "evidence-only-support",
    riskClassification: "regulated",
    criticality: "high",
    riskDrivers: [
      "tenant analytics data access",
    ...
    resiliencePosture: {
      connectTimeout: "deferred-until-provider-adapter-exists",
      requestTimeout: "deferred-until-provider-adapter-exists",
      retryPolicy: "deferred-fail-closed-no-hidden-in-memory-fallback",
  ...
  makeProvider({
    ...
    providerName: "SonarQube composed-test quality-gate provider",
    providerCategory: "quality-gate",
    providerMode: "composed-test",
    owningCapability: "static-analysis-quality-gate",
    portName: "QualityGateProvider",
    adapterName: "SonarQubeComposedQualityGateAdapter",
    businessPurpose:
      "SDK-backed local Compose SonarQube proof for synthetic scan submission, quality-gate readback, issue and hotspot query paths, operator auth validation, cleanup, and unavailable-provider fail-closed behaviour.",
    dataClassification: "confidential",
    healthStatus: "healthy",
    readinessStatus: "healthy",
    capabilityStatus: "healthy",
    explicitAuthorityRef: "spec/instances/compose-service/service-catalogue.json#sonarqube",
    endpointRef: "endpoint://compose/sonarqube",
    secretRef: null,
    sourceUseDisposition: "new-with-rationale",
    ...
    riskDrivers: [
      ...
      "source-analysis metadata retention",
    ...
    resiliencePosture: {
      connectTimeout: "10s",
      requestTimeout: "10s",
      retryPolicy: "bounded-exponential-backoff-240s",
      circuitBreakerPolicy: "fail-closed-unavailable-state",
    },
    credentialPosture: {
      secretClassification: "credential-metadata",
      credentialScope: "compose_local_sonarqube_admin_credential",
      leastPrivilegePolicy:
        "local Compose proof generates a temporary scanner credential, uses it only for synthetic project analysis and readback, then revokes it",
    },
    supplierPosture: { subprocessorStatus: "not-live-local-compose-only" },
    permissionGrants: [
      {
        providerAction: "quality_gate.synthetic_project.scan",
        providerPermission: "write",
        credentialScope: "compose_local_sonarqube",
        allowedResourceScope: "synthetic-proof-project-only",
        tenantScope: "tenant-scoped",
      },
      {
        providerAction: "quality_gate.status.read",
        providerPermission: "read",
        credentialScope: "compose_local_sonarqube",
        allowedResourceScope: "synthetic-proof-project-only",
        tenantScope: "tenant-scoped",
      ...
      {
        providerAction: "quality_gate.synthetic_project.cleanup",
        providerPermission: "delete",
        credentialScope: "compose_local_sonarqube",
        allowedResourceScope: "synthetic-proof-project-only",
        tenantScope: "tenant-scoped",
    ...
    driftPosture: {
      driftStatus: "in-sync",
      expectedConfigHash: "compose-sonarqube-assurance-profile",
    },
  }),
  makeProvider({
    providerId: "cache-redis-composed-test",
    providerName: "Redis composed-test cache provider",
    providerCategory: "cache",
    providerMode: "composed-test",
    owningCapability: "cache-eventing",
    portName: "CacheProvider",
    adapterName: "RedisComposedCacheAdapter",
    businessPurpose:
      "SDK-backed local Compose Redis cache proof for synthetic tenant-safe write/read/delete, TTL, cleanup, and unavailable-provider fail-closed behaviour.",
    dataClassification: "confidential",
    healthStatus: "healthy",
    readinessStatus: "healthy",
    capabilityStatus: "healthy",
    explicitAuthorityRef: "spec/instances/compose-service/service-catalogue.json#redis",
    endpointRef: "endpoint://compose/redis",
    secretRef: null,
    sourceUseDisposition: "new-with-rationale",
    riskClassification: "high",
    criticality: "high",
    riskDrivers: ["tenant state access", "expiration semantics", "availability dependency"],
    transportPosture: { tlsRequired: false, certificateValidationRequired: false },
    resiliencePosture: {
      connectTimeout: "2s",
      requestTimeout: "2s",
      retryPolicy: "bounded-exponential-backoff-60s",
      circuitBreakerPolicy: "fail-closed-unavailable-state",
    },
    credentialPosture: {
      secretClassification: "none",
      credentialScope: "compose_local_redis_no_auth",
      leastPrivilegePolicy:
        "local Compose Redis proof uses no credential and grants only synthetic cache set/get/delete/ttl actions",
    },
    supplierPosture: { subprocessorStatus: "not-live-local-compose-only" },
    permissionGrants: [
      {
        providerAction: "cache.set",
        providerPermission: "write",
        credentialScope: "compose_local_redis",
        allowedResourceScope: "tenant-keyspace",
        tenantScope: "tenant-scoped",
      },
      {
        providerAction: "cache.get",
        providerPermission: "read",
        credentialScope: "compose_local_redis",
        allowedResourceScope: "tenant-keyspace",
        tenantScope: "tenant-scoped",
    ...
    driftPosture: { driftStatus: "in-sync", expectedConfigHash: "compose-redis-runtime-providers" },
  }),
  makeProvider({
    providerId: "cache-redis-deferred",
    providerName: "Redis cache provider class",
    providerCategory: "cache",
    providerMode: "live-external-deferred",
    owningCapability: "cache-eventing",
    portName: "CacheProvider",
    adapterName: "Redis provider deferred",
    businessPurpose:
      "Recognised Redis-compatible cache provider class; not implemented, not equivalent to NATS, and not ready for composed-provider claims.",
    dataClassification: "confidential",
    healthStatus: "deferred",
    readinessStatus: "deferred",
    capabilityStatus: "deferred",
  ...
  makeProvider({
    providerId: "file-scan-clamav-composed-test",
    providerName: "ClamAV composed-test scan provider",
    providerCategory: "file-scan",
    providerMode: "composed-test",
    owningCapability: "files-storage",
    portName: "ScanProvider",
    ...
    businessPurpose:
      "SDK-backed local ClamAV clean/infected scan, provider-unavailable fail-closed quarantine, and redacted evidence proof for synthetic file payloads.",
    dataClassification: "restricted",
    environmentScope: "local-composed-test",
    ...
    capabilityStatus: "healthy",
    riskClassification: "security-sensitive",
    riskDrivers: ["file/object handling", "regulated data handling", "malware-scan decision"],
    availabilityDependency: "required-for-profile-gated-clamav-scanner-proof",
    explicitAuthorityRef: "spec/instances/compose-service/service-catalogue.json#clamav",
    sourceUseDisposition: "new-with-rationale",
    transportPosture: { tlsRequired: false, certificateValidationRequired: false },
    permissionGrants: [
      {
        providerAction: "scan-synthetic-clean-payload",
        providerPermission: "read",
        credentialScope: "no-credential-local-compose",
        allowedResourceScope: "synthetic-proof-payloads-only",
        tenantScope: "tenant-scoped",
      },
      {
        providerAction: "scan-synthetic-eicar-test-payload",
        providerPermission: "read",
        credentialScope: "no-credential-local-compose",
        allowedResourceScope: "synthetic-proof-payloads-only",
        tenantScope: "tenant-scoped",
      ...
      {
        providerAction: "fail-closed-quarantine-evidence",
        providerPermission: "write",
        credentialScope: "no-credential-local-compose",
        allowedResourceScope: "value-free-audit-evidence-only",
        tenantScope: "tenant-scoped",
      },
    ],
    resiliencePosture: {
      connectTimeout: "180s-local-compose-readiness-budget",
      requestTimeout: "30s-local-compose",
      retryPolicy: "bounded-exponential-backoff-no-unbounded-retry",
      circuitBreakerPolicy: "fail-closed-quarantine-proof",
    },
    driftPosture: { driftStatus: "in-sync", expectedConfigHash: "compose-clamav-pinned" },
    supplierPosture: { subprocessorStatus: "not-a-live-provider-local-compose-only" },
  }),
  makeProvider({
  ...
  makeProvider({
    providerId: "operational-job-engine-windmill-composed-test",
    providerName: "Windmill configured local Compose proof provider",
    providerCategory: "operational-job-engine",
    providerMode: "composed-test",
    lifecycleState: "approved-for-composed-test",
    owningCapability: "jobs-workflows",
    portName: "OperationalJobEngine",
    adapterName: "Windmill configured proof provider boundary",
    businessPurpose:
      "Proof-only local Windmill operator automation boundary for USF-212 configured bootstrap, SDK auth, synthetic workspace/script/job, audit, fail-closed, and teardown evidence.",
    endpointRef: "endpoint://compose/windmill",
    credentialRef: {
      secretRef: "secret://compose/windmill-superadmin-placeholder",
      secretProvider: "local-compose-placeholder",
      scope: "local-compose-proof",
      version: "1",
      status: "active",
      rotationPolicy: "local-placeholder-no-live-rotation-claim",
      lastRotatedAt: null,
      nextRotationDueAt: null,
    ...
    readinessStatus: "healthy",
    capabilityStatus: "healthy",
    explicitAuthorityRef: "spec/instances/compose-service/service-catalogue.json#windmill",
    sourceUseDisposition: "new-with-rationale",
    riskClassification: "high",
    riskDrivers: [
      ...
      "sdk:windmill-client",
      "sdk-version:1.743.0",
      "healthReadinessStatus:healthy-for-USF-212-proof-only",
      "service-catalogue:windmill,windmill-worker,windmill-postgres,windmill-redis",
      "no-windmill-readiness",
      "no-operator-automation-readiness",
    ],
    permissionGrants: [
      {
        providerAction: "run-synthetic-windmill-proof",
        providerPermission: "execute",
        credentialScope: "local-compose-superadmin-placeholder-only",
        allowedResourceScope: "synthetic-workspace-only",
        tenantScope: "tenant-scoped",
      },
    ],
    credentialPosture: {
      credentialScope: "local-compose-superadmin-placeholder-only",
      leastPrivilegePolicy:
        "USF-212 proof-only placeholder for synthetic workspace/script execution; no live credential claim",
      rotationPolicy: "local-placeholder-no-live-rotation-claim",
    },
    transportPosture: {
      tlsRequired: false,
      certificateValidationRequired: false,
      certificatePinningPolicy: "loopback-http-local-compose-only-no-live-provider-claim",
    },
    resiliencePosture: {
      connectTimeout: "80-attempt-local-compose-readiness-budget",
      requestTimeout: "30s-local-compose",
      retryPolicy: "bounded-exponential-backoff-no-unbounded-retry",
      circuitBreakerPolicy: "fail-closed-proof",
    },
  ...
  makeProvider({
    ...
    readinessStatus: "deferred",
    capabilityStatus: "deferred",
    explicitAuthorityRef: "spec/instances/compose-service/service-catalogue.json#webhook-sink",
    sourceUseDisposition: "evidence-only-support",
    riskClassification: "security-sensitive",
  ...
  makeProvider({
    providerId: "notification-delivery-webhook-sink-deferred",
    providerName: "Webhook sink capture provider class",
    providerCategory: "notification-delivery",
    providerMode: "live-external-deferred",
    owningCapability: "provider-mocks",
    portName: "WebhookCaptureProvider",
    adapterName: "Webhook sink provider deferred",
    businessPurpose:
      "Recognised webhook capture provider class; not equivalent to live notification delivery and not adapter-bound in this runtime proof.",
    dataClassification: "restricted",
    healthStatus: "deferred",
    readinessStatus: "deferred",
    capabilityStatus: "deferred",
    ...
    sourceUseDisposition: "evidence-only-support",
    riskClassification: "security-sensitive",
    riskDrivers: ["notification delivery", "tenant data access", "retention boundary"],
    transportPosture: { tlsRequired: true, certificateValidationRequired: true },
    supplierPosture: { subprocessorStatus: "future-review-required" },
  }),
  makeProvider({
    providerId: "notification-delivery-webhook-sink-composed-test",
    providerName: "Webhook sink local capture provider",
    providerCategory: "notification-delivery",
    providerMode: "composed-test",
    owningCapability: "provider-mocks",
    portName: "WebhookCaptureProvider",
    ...
    businessPurpose:
      "Profile-gated local Compose webhook capture proof; not notification delivery, provider feedback, replay, or live webhook compatibility.",
    dataClassification: "confidential",
    environmentScope: "local-composed-test",
    ...
    sourceUseDisposition: "new-with-rationale",
    riskClassification: "medium",
    riskDrivers: ["mock provider behaviour", "tenant data access", "retention boundary"],
    lifecycleState: "approved-for-composed-test",
    permissionGrants: [
      {
        providerAction: "write-synthetic-webhook-capture",
        providerPermission: "write",
        credentialScope: "no-credential-local-compose",
        allowedResourceScope: "synthetic-proof-captures-only",
        tenantScope: "tenant-scoped",
      },
      {
        providerAction: "readback-synthetic-webhook-capture",
        providerPermission: "read",
        credentialScope: "no-credential-local-compose",
        allowedResourceScope: "synthetic-proof-captures-only",
        tenantScope: "tenant-scoped",
    ...
    transportPosture: { tlsRequired: false, certificateValidationRequired: false },
    resiliencePosture: {
      connectTimeout: "60s-local-compose-readiness",
      requestTimeout: "5s-local-compose",
      retryPolicy: "bounded-exponential-backoff",
      circuitBreakerPolicy: "fail-closed-capture-unavailable",
    },
    driftPosture: { driftStatus: "in-sync", expectedConfigHash: "compose-webhook-sink-pinned" },
    incidentPosture: {
      providerIncidentStatus: "none",
      customerImpactPolicy: "local-composed-proof-only-no-customer-impact-claim",
    },
    supplierPosture: {
      supplierNameRef: "supplier://mendhak-http-https-echo",
      subprocessorStatus: "not-applicable-local-mock",
      dataProcessingRole: "local-compose-synthetic-data-capture",
      contractStatus: "not-claimed",
      securityReviewStatus: "not-claimed",
      privacyReviewStatus: "not-claimed",
    },
  ...
  makeProvider({
    ...
    providerName: "Sentry SDK local envelope proof",
    providerCategory: "observability",
    providerMode: "local-test",
    owningCapability: "observability",
    portName: "ObservabilitySink",
    ...
    businessPurpose:
      "Official Sentry Node SDK envelope proof for synthetic local event capture and redaction boundary; not Sentry service readiness.",
    dataClassification: "confidential",
    environmentScope: "local-dev",
    endpointRef: "endpoint://not-generated/sentry-sdk-envelope-proof",
    healthStatus: "healthy",
    readinessStatus: "deferred",
    capabilityStatus: "deferred",
    explicitAuthorityRef: "spec/instances/compose-service/service-catalogue.json#sentry",
    sourceUseDisposition: "new-with-rationale",
    riskClassification: "high",
    criticality: "medium",
    riskDrivers: ["audit/evidence function", "tenant metadata", "readiness overclaim risk"],
    transportPosture: { tlsRequired: false, certificateValidationRequired: false },
    resiliencePosture: {
      connectTimeout: "not-applicable-local-in-memory-transport",
      requestTimeout: "bounded-flush-timeout-2000ms",
      retryPolicy: "no-network-retry-local-transport",
      circuitBreakerPolicy: "fail-closed-on-unavailable-transport",
    },
    supplierPosture: { subprocessorStatus: "not-applicable-local-sdk-proof" },
  }),
  makeProvider({
    providerId: "backup-restore-pgbackrest-composed-test",
    providerName: "pgBackRest configured local cold backup restore proof",
    providerCategory: "backup-restore",
    providerMode: "composed-test",
    owningCapability: "backup-restore",
    portName: "BackupRestoreProvider",
    adapterName: "pgBackRest CLI proof boundary",
    businessPurpose:
      "Configured local Compose pgBackRest cold backup and restore drill proof for synthetic Postgres data; not backup readiness, restore readiness, PITR, RPO/RTO, disaster recovery, live-provider, staging, or production readiness.",
    dataClassification: "restricted",
    environmentScope: "local-composed-test",
    ...
    readinessStatus: "healthy",
    capabilityStatus: "healthy",
    explicitAuthorityRef: "spec/instances/compose-service/service-catalogue.json#pgbackrest",
    sourceUseDisposition: "new-with-rationale",
    riskClassification: "critical",
    criticality: "critical",
    riskDrivers: [
    ...
    transportPosture: { tlsRequired: false, certificateValidationRequired: false },
    resiliencePosture: {
      connectTimeout: "bounded-postgres-healthcheck-and-pgbackrest-version-retry",
      requestTimeout: "pgbackrest-proof-command-timeout-240s",
      retryPolicy: "bounded-exponential-postgres-and-pgbackrest-readiness-retry",
      circuitBreakerPolicy: "fail-closed-on-missing-repository-stanza-or-restore-readback",
    },
    supplierPosture: { subprocessorStatus: "not-applicable-local-compose-proof" },
  }),
  makeProvider({
    providerId: "backup-restore-pgbackrest-deferred",
    providerName: "pgBackRest backup and restore provider class",
    providerCategory: "backup-restore",
    providerMode: "live-external-deferred",
    owningCapability: "backup-restore",
    portName: "BackupRestoreProvider",
    ...
    businessPurpose:
      "Recognised backup and restore provider class for boundaries beyond the local cold backup/restore proof; no online backup, WAL archive, PITR, RPO/RTO, disaster recovery, live-provider, staging, production, or scheduled backup readiness is claimed.",
    dataClassification: "restricted",
    healthStatus: "deferred",
    readinessStatus: "deferred",
    capabilityStatus: "deferred",
    ...
    transportPosture: { tlsRequired: true, certificateValidationRequired: true },
    resiliencePosture: {
      connectTimeout: "deferred-for-provider-managed-or-environment-promoted-backup-service",
      requestTimeout: "deferred-for-online-backup-pitr-and-dr-proof",
      retryPolicy: "deferred-for-scheduled-backup-and-provider-managed-operation",
      circuitBreakerPolicy: "deferred-fail-closed",
    },
    supplierPosture: { subprocessorStatus: "future-review-required" },
  }),
  makeProvider({
    providerId: "provider-emulator-localstack-deferred",
    providerName: "LocalStack cloud provider emulator class",
    providerCategory: "provider-emulator",
    providerMode: "live-external-deferred",
    owningCapability: "provider-mocks",
    portName: "CloudProviderEmulator",
    adapterName: "LocalStack provider deferred",
    businessPurpose:
      "Recognised local cloud-provider emulator class; not equivalent to live provider readiness and not adapter-bound in this runtime proof.",
    dataClassification: "confidential",
    healthStatus: "deferred",
    readinessStatus: "deferred",
    capabilityStatus: "deferred",
    explicitAuthorityRef: "spec/instances/compose-service/service-catalogue.json#localstack",
    sourceUseDisposition: "evidence-only-support",
    riskClassification: "high",
    riskDrivers: ["mock provider behaviour", "credential placeholder handling", "egress control"],
    transportPosture: { tlsRequired: false, certificateValidationRequired: false },
    supplierPosture: { subprocessorStatus: "not-applicable-local-mock" },
  }),
  makeProvider({
    providerId: "provider-emulator-localstack-composed-test",
    providerName: "LocalStack local cloud provider emulator proof",
    providerCategory: "provider-emulator",
    providerMode: "composed-test",
    owningCapability: "provider-mocks",
    portName: "CloudProviderEmulator",
    ...
    businessPurpose:
      "Profile-gated local Compose LocalStack proof for S3 SQS SNS and Secrets Manager emulator semantics only; not live cloud-provider compatibility or provider certification.",
    dataClassification: "confidential",
    healthStatus: "healthy",
    readinessStatus: "healthy",
    capabilityStatus: "healthy",
    ...
    transportPosture: { tlsRequired: false, certificateValidationRequired: false },
    credentialPosture: {
      credentialScope: "localstack-placeholder-credentials-local-compose-only",
      leastPrivilegePolicy:
        "placeholder credentials are accepted only by local Compose LocalStack emulator services",
    },
    resiliencePosture: {
      connectTimeout: "bounded-exponential-backoff-no-unbounded-retry",
      requestTimeout: "aws-sdk-request-timeout-5s",
      retryPolicy: "bounded-exponential-backoff-no-unbounded-retry",
      circuitBreakerPolicy: "fail-closed-unavailable",
    },
    supplierPosture: { subprocessorStatus: "not-applicable-local-mock" },
    driftPosture: { driftStatus: "in-sync", expectedConfigHash: "compose-localstack-pinned" },
  }),
  makeProvider({
    providerId: "provider-mock-wiremock-deferred",
    providerName: "WireMock HTTP provider mock class",
    providerCategory: "provider-mock",
    providerMode: "live-external-deferred",
    owningCapability: "provider-mocks",
    portName: "HttpProviderMock",
    adapterName: "WireMock provider deferred",
    businessPurpose:
      "Recognised HTTP provider mock class; fixture capture does not prove live external provider semantics.",
    dataClassification: "confidential",
    healthStatus: "deferred",
    readinessStatus: "deferred",
    capabilityStatus: "deferred",
    explicitAuthorityRef: "spec/instances/compose-service/service-catalogue.json#wiremock",
    sourceUseDisposition: "evidence-only-support",
    riskClassification: "medium",
    riskDrivers: ["mock provider behaviour", "contract fixture drift", "egress control"],
    transportPosture: { tlsRequired: false, certificateValidationRequired: false },
    supplierPosture: { subprocessorStatus: "not-applicable-local-mock" },
  }),
  makeProvider({
    providerId: "provider-mock-wiremock-composed-test",
    providerName: "WireMock local HTTP provider mock proof",
    providerCategory: "provider-mock",
    providerMode: "composed-test",
    owningCapability: "provider-mocks",
    portName: "HttpProviderMock",
    ...
    businessPurpose:
      "Profile-gated local Compose WireMock proof for configured HTTP request matching and response templating only; not live external provider compatibility or provider contract certification.",
    dataClassification: "confidential",
    healthStatus: "healthy",
    readinessStatus: "healthy",
    capabilityStatus: "healthy",
    ...
    resiliencePosture: {
      connectTimeout: "bounded-exponential-backoff-no-unbounded-retry",
      requestTimeout: "wiremock-client-request-timeout-5s",
      retryPolicy: "bounded-exponential-backoff-no-unbounded-retry",
      circuitBreakerPolicy: "fail-closed-unavailable",
    },
    supplierPosture: { subprocessorStatus: "not-applicable-local-mock" },
    driftPosture: { driftStatus: "in-sync", expectedConfigHash: "compose-wiremock-pinned" },
  }),
  makeProvider({
  ...
  makeProvider({
    providerId: "full-text-search-meilisearch-deferred",
    providerName: "Meilisearch full-text search provider class",
    providerCategory: "full-text-search",
    providerMode: "live-external-deferred",
    owningCapability: "search-indexing",
    portName: "SearchIndexPort",
    adapterName: "Meilisearch provider deferred",
    businessPurpose:
      "Recognised Meilisearch provider class; in-memory search proof is not equivalent to composed Meilisearch indexing, query, ranking, filter, deletion, or reindex proof.",
    dataClassification: "restricted",
    healthStatus: "deferred",
    readinessStatus: "deferred",
    capabilityStatus: "deferred",
    explicitAuthorityRef: "spec/instances/compose-service/service-catalogue.json#meilisearch",
    sourceUseDisposition: "evidence-only-support",
    riskClassification: "regulated",
    riskDrivers: [
      "tenant data access",
  ...
  makeProvider({
    providerId: "full-text-search-meilisearch-composed-test",
    providerName: "Meilisearch composed local proof provider",
    providerCategory: "full-text-search",
    providerMode: "composed-test",
    owningCapability: "search-indexing",
    portName: "MeilisearchComposedSearchAdapter",
    adapterName: "MeilisearchComposedSearchAdapter",
    businessPurpose:
      "SDK-backed local Meilisearch indexing, tenant-filtered query, delete, update/reindex boundary, readiness retry, redacted failure, and cleanup proof for synthetic search documents only.",
    dataClassification: "restricted",
    healthStatus: "healthy",
    readinessStatus: "healthy",
    capabilityStatus: "healthy",
    ...
    riskDrivers: [
      ...
      "regulated data handling",
      "availability dependency",
      "search result disclosure",
    ],
    transportPosture: {
      tlsRequired: false,
      certificateValidationRequired: false,
      insecureSkipVerifyAllowed: false,
      certificatePinningPolicy: "not-required-for-loopback-local-compose-proof",
    },
    resiliencePosture: {
      connectTimeout: "2000ms per SDK request",
      requestTimeout: "2000ms per SDK request",
      retryPolicy: "bounded-exponential-backoff-no-unbounded-retry",
      circuitBreakerPolicy: "fail-closed-on-readiness-or-task-failure",
    },
    supplierPosture: {
      subprocessorStatus: "local-compose-only-no-live-provider-claim",
      securityReviewStatus: "future-review-required-before-live-provider-use",
      privacyReviewStatus: "future-review-required-before-live-provider-use",
    },
  }),
  makeProvider({
