...
# Host-side pipeline over the repository-root graph/ and census/ (never runs
# in the chroot, which is graph-free); the compiler lives in the usf-graph
# submodule. Env vars override the defaults.
USF_DIR="$REPO_ROOT/v2/usf"
