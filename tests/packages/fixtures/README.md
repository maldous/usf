...
This directory contains the USF-248 synthetic fixture corpus for the test-readiness track.

The corpus is repository evidence for seed, reset, cleanup, teardown, repeatability, failure-recovery, and provenance expectations. It is not live provider evidence and does not claim final test readiness.
